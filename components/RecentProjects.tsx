...
const RecentProjects = () => {
  return (
    <div  className='py-20' id='projects'>
        ...
        <div className='flex flex-wrap items-center justify-center p-4 gap-16 gap-y-8 mt-10'>
           {projects.map(({
            id,
            title,
            des,
            ...
            <div key={id} className='sm:h-[41rem] h-[25rem] lg:min-h-[32.5rem] flex items-center justify-center sm:w-[570px] w-[80vw]'>
              <PinContainer title={title} href={link}>
               <div className='relative flex items-center justify-center sm:w-[570px] w-[80vw] overflow-hidden sm:h-[40vh] lg:h-[30vh]  mb-10' >
                ...
                <img src={img} alt={title} className='z-10 absolute bottom-10'/>
               </div>
                ...
                <p className='lg:text-xl lg:font-normal font-light text-sm line-clamp-2'>
                  ...
                  <div className='flex items-center justify-between mt-7 mb-3'>
                    ...
                    <div className='flex justify-center items-center '>
                      <p className='flex lg:text-xl md:text-xs text-sm test-purple'>Check Live Site</p>
